const app = {
    ...
    chosenTableColor: app.tableObject.colorTableName,
    ...
    initListeners: () => {
        ...
        document.querySelector('#hexButton').addEventListener('click', getColorTable);
        document.querySelector('#normalButton').addEventListener('click', getColorTable);
    },
    ...
    changeColor: (event) => {
        ...
        console.log('Le nombre aléatoire : ', randomNb);        

        // On change la couleur du body
        document.querySelector('body').style.backgroundColor = app.tableObject.colorTableName[randomNb];
        document.querySelector('#color-span').textContent = app.tableObject.colorTableName[randomNb].toLocaleUpperCase();
    }
